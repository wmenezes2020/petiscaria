...
// Dynamic import do motion com SSR desabilitado para evitar hydration mismatch
...
export default function HomePage() {
  ...
  // Render sempre o mesmo HTML, apenas animações após mount
  const MotionComponent = isMounted ? MotionDiv : 'div';
